jQuery(document).ready(function ($) {
    ...
    $("#create").click(function (event) {
        ...
        handleAjaxRequest('create', formData, 'Project created successfully.', 'Failed to create project.');
        return false;
    });
    ...
    $("#update").click(function (event) {
        ...
        handleAjaxRequest('update', formData, 'Project updated successfully.', 'Failed to update project.');
        return false;
    });
    ...
    $(document).on('click', '.select-project', function () {
        ...
        if (projectData.image_name) {
            $('#image_preview').show();
            $('#project_image').attr('src', '../upload/project/' + projectData.image_name);
        } else {
            $('#image_preview').hide();
        }
    ...
    $(document).on('click', '.delete-project', function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                handleAjaxRequest('delete', { id: projectId, delete: true },
