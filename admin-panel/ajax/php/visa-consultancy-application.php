...
if (isset($_POST['create'])) {
    ...
    $VCA = new VisaConsultancyApplication(); // New object
...
// Update Visa Consultancy Application
if (isset($_POST['update']) && isset($_POST['id'])) {

    $VCA = new VisaConsultancyApplication($_POST['id']); // Load by ID
...
// Delete Visa Consultancy Application
if (isset($_POST['delete']) && isset($_POST['id'])) {

    $VCA = new VisaConsultancyApplication($_POST['id']);
    $res = $VCA->delete();
