                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($SKILLS_TRAINING_APPLICATION->getApplicationsByWithOutStaffId() as $key => $skills_training_application) {
                                                ...
                                                ?>
                                                <tr id="div<?php echo $skills_training_application['id'] ?>">
                                                    <td><?php echo $key ?></td>
                                                    <td> <?php echo $skills_training_application['full_name'] ?></td>
                                                    <td> <?php echo $skills_training_application['passport_number'] ?></td>
                                                    <td> <?php echo $skills_training_application['mobile_number'] ?></td> 
                                                    <td> <?php echo $skills_training_application['current_job'] ?></td>
                                                    <td> <?php echo $JOB_ROLES->name?></td>
                                                    <td> <?php echo $skills_training_application['created_at'] ?></td>
                                                    <td>
                                                        <a href="view-skills-training-application.php?id=<?php echo $skills_training_application['id'] ?>">
