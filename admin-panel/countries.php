                                ...
                                <div class="card-body">
                                    ...
                                    <form id="form-data" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label>Commission Rate (LKR) Staff <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label>Commission Rate (LKR) Agent <span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <input type="number" step="0.01" id="commission_rate_agent" name="commission_rate_agent" class="form-control" placeholder="e.g., 5000.00" required>
                                                    <span class="input-group-text">LKR</span>
                                                </div>
                                            </div>
                                        ...
                                        <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Country Name</th>
                                                    <th>Commission Rate Staff</th>
                                                    <th>Commission Rate Agent</th>
                                                    <th>Status</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                if (!empty($countries)) {
                                                    foreach ($countries as $country) {
                                                        ...
                                                        echo "<td>LKR " . number_format(htmlspecialchars($country['commission_rate_staff'] ?? '0.00'), 2) . "</td>";
                                                        echo "<td>LKR " . number_format(htmlspecialchars($country['commission_rate_agent'] ?? '0.00'), 2) . "</td>";
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-country', function() {
                ...
                var rate_agent = $(this).data('rate_agent');
