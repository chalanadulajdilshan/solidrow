                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            $applications = $VISA_CONSULTANCY_APPLICATION->getApplicationsByWithStaffId($staff_id, $call_status, $employee_status);
                                            foreach ($applications as $key => $visa_consultancy_application) {
                                                $key++;
