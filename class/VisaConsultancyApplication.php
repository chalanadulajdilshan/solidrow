...
class VisaConsultancyApplication
{
    ...
    {
        if ($id) {
            $query = "SELECT * FROM visa_consultancy_application WHERE id=" . $id;
            $db = new Database();
            ...
            $this->visa_category = $result['visa_category'];
        }
    }

    public function create()
    {
        $query = "INSERT INTO visa_consultancy_application (full_name, staff_id, nic, passport_number, birthday, age, gender, marital_status, mobile_number, whatsapp_number, province_id, current_job, job_abroad, type, created_at, country_id, visa_category) VALUES ('"
            . $this->full_name . "', '"
            . $this->staff_id . "', '"
            . $this->nic . "', '"
    ...
    {
        $query = "UPDATE visa_consultancy_application SET "
    ...
    {
        $query = "DELETE FROM visa_consultancy_application WHERE id='" . $this->id . "'";
        $db = new Database();
        return $db->readQuery($query);
    }
    ...
    public function all()
    {
        $query = "SELECT * FROM visa_consultancy_application ORDER BY created_at DESC";
        $db = new Database();
        $result = $db->readQuery($query);
    ...
    {
        $query = "SELECT * FROM visa_consultancy_application WHERE staff_id = 0 ORDER BY created_at DESC";
        $db = new Database();
        $result = $db->readQuery($query);
    ...
    {
        $db = new Database();
        $query = "SELECT * FROM visa_consultancy_application WHERE staff_id = $staff_id ";
