...
<body class="authentication-bg someBlock">
                            ...
                            <div class="p-2 mt-4">
                                <form id="form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="country_id">රට (Country) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="visa_category">වීසා වර්ගය (Visa Category) <span class="text-danger">*</span></label>
                                                <select id="visa_category" name="visa_category" class="form-control" required disabled>
                                                    <option value="">පළමුව රට තෝරන්න (Select country first)</option>
                                                </select>
                                            </div>
                                        </div>
    ...
    <script src="../ajax/js/visa-consultancy-application.js"></script>
